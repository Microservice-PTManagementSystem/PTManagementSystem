...
export default function Home() {
   ...
   const trainers = [
      {
         ...
         imageUrl: "/assets/trainer_jamie.jpg",
      },
      {
         id: "2",
         name: "MARK",
   ...
   const makeReservation = async (e) => {
      ...
      try {
         ...
         const { cardHolder, cardNumber, expiryMonth, expiryYear, cvc } = paymentInfo;
      ...
      <div className="flex min-h-screen flex-col">
            ...
            <div className="container mx-auto px-4 py-4">
               <div className="flex items-center justify-between">
                  ...
                  <nav className="hidden md:flex space-x-6">
                     ...
                     <Link href="/contact-us" className="text-sm hover:text-orange-500">
                        Contact Us
                     </Link>
                  </nav>
                  ...
                  <div className="flex items-center space-x-6">
                     ...
                     <div className="flex items-center space-x-4">
                        <button type="button" onClick={handleSignOut} className="bg-red-600 p-2 rounded hover:bg-red-800">
         ...
         <section className="relative bg-black text-white">
            ...
            <div className="relative h-[500px]">
               <Image src="/assets/gym_background.jpg" alt="Gym background" layout="fill" objectFit="cover" className="z-0" />
            </div>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20">
               ...
               <p className="max-w-2xl mb-8 text-gray-300">
                  A gym is more than a place to work out. It's a place to grow, to push yourself, to discover what you're capable of. Join us and
                  transform your life.
               </p>
               <p className="max-w-2xl mb-8 text-gray-300">"Discipline, Agility, Lift, Muscle, Strength"</p>
               <button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-full">JOIN NOW</button>
            </div>
         </section>
                  ...
                  {trainers.map((trainer) => (
                     <div key={trainer.id} className="bg-gray-800">
                        <div className="h-100 w-120 relative">
                           <Image src={trainer.imageUrl} alt={`Trainer ${trainer.name}`} fill className="object-cover" />
                        </div>
                  ...
                  {!changeActive ? (
                              ...
                              {slots.map((slot, idx) => {
                                 ...
                                 return (
                                    <li key={idx} className="bg-gray-800 p-3 rounded">
                                       <p>
                                          <span className="font-semibold">Date and time:</span> {start.toLocaleDateString()} -{" "}
                     ...
                     <>
                        ...
                        <div className="space-y-3 text-sm">
                           ...
                           <p>
                              <span className="font-semibold">Start:</span> {new Date(selectedSlot?.start_time).toLocaleString()}
                           </p>
                           <p>
                              <span className="font-semibold">End:</span> {new Date(selectedSlot?.end_time).toLocaleString()}
                           </p>
                           <p className="mt-4">Do you confirm your appointment?</p>
                           <div className="flex justify-end gap-4 mt-4">
                              <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full" onClick={makeReservation}>
                                 Confirm
                              </button>
                              <button
