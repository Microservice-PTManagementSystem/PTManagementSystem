...
function SignUpForm() {
  ...
  /*const handleSubmit = async (e) => {  
    ...
    // 🔑 Kayıt işlemini Keycloak üzerinden tetiklemek için aşağıdaki satırı kullanıyoruz:
    signIn("keycloak", {
      callbackUrl: "/", // Girişten sonra yönlendirme yapılacak sayfa
      kc_registration: "true", // Bu parametre, Keycloak ekranında register sayfasını açar
    });
  };*/
